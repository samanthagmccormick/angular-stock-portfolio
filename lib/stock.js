...
Stock.prototype.quote = function() {
  ...
  console.log('incoming quoteId: ' + quoteId);

  // stores stock price into activeQuotes
  this.activeQuotes[quoteId] = this.price;

  console.log(this.activeQuotes[quoteId]);
...
Stock.prototype.setGrowthRate = function(growthRate) {
  this.growthRate = growthRate;
}

Stock.prototype.setChangeInterval = function(changeInterval) {
  this.changeInterval = changeInterval;
}

Stock.prototype.setVolatilityPercent = function(volatilityPercent) {
  this.volatilityPercent = volatilityPercent;
}
